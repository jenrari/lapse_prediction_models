...
from src.model_utils.oversampling import over_bsm, over_sm, over_adasyn, over_svmsm
...
# def run_model_and_evaluate(name, model, X_train, y_train, X_test, y_test):
#
...
def run_model_and_evaluate(name, model, X_train, y_train, X_test, y_test, sampler=None,
    ...
    threshold = threshold_max_recall(
